...
<!-- [![](.images/screenshot.png)](https://nextra-docs-template.vercel.app) -->
...
1. **Fork and Clone the Repository**: Clone the project to your local machine to get started.
   ```
   git clone https://github.com/Southern-Cross-AI/docs.git
   ```
...
https://docs-mh552qxys-southern-cross-ai.vercel.app/
